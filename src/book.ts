...
export const PAGES: Page[] = [
  {
    ...
    extras: [
      { flash: "window-peek", sfx: "mew", hotspot: { x: 33, y: 50, w: 16, h: 22 } }, // left house window
  ...
  },
  {
    ...
    extras: [
      { flash: "moon-bright", sfx: "chime", hotspot: { x: 1, y: 12, w: 18, h: 28 } }, // window + moon, far left
  ...
  },
  {
    ...
    extras: [
      ...
      { flash: "mouse-peek", sfx: "squeak", hotspot: { x: 1, y: 74, w: 16, h: 22 } }, // mouse, bottom-left
    ],
  },
  {
    id: 5,
    ...
    extras: [
      { flash: "moon-bright", sfx: "chime", hotspot: { x: 13, y: 4, w: 22, h: 24 } }, // moon, upper-left
      { flash: "pumpkin-bright", sfx: "pop", hotspot: { x: 66, y: 66, w: 22, h: 26 } }, // porch jack-o'-lantern
      { flash: "bush-hog", sfx: "rustle", hotspot: { x: 3, y: 60, w: 32, h: 24 } }, // bushes, lower-left
    ],
  },
  {
    id: 6,
    ...
    interaction: {
      ...
      count: 1,
      stickers: ["cat"],
      hotspot: { x: 46, y: 52, w: 16, h: 20 }, // the sticker in 小猫's paw
    },
    extras: [
      { flash: "cat-tail", sfx: "purr", hotspot: { x: 66, y: 46, w: 14, h: 26 } }, // 小猫's tail, curls up
      { flash: "window-kitten", sfx: "mew", hotspot: { x: 73, y: 40, w: 17, h: 22 } }, // right-side window
      { flash: "pumpkin-bright", sfx: "pop", hotspot: { x: 66, y: 68, w: 20, h: 24 } }, // porch pumpkin
    ],
  },
  {
    id: 7,
    ...
    extras: [
      { flash: "lantern-bright", sfx: "flare", hotspot: { x: 84, y: 8, w: 16, h: 40 } }, // paper lantern, right
      { flash: "tree-leaves", sfx: "rustle", hotspot: { x: 18, y: 16, w: 24, h: 48 } }, // autumn tree, left
      { flash: "hedge-hog", sfx: "rustle", hotspot: { x: 2, y: 54, w: 36, h: 22 } }, // the hedge, left
    ],
  },
  {
    id: 8,
    ...
    interaction: {
      ...
      hotspot: { x: 52, y: 50, w: 16, h: 20 }, // the two stickers in 小熊's paw
    },
    extras: [
      { flash: "bear-wave", sfx: "pop", hotspot: { x: 64, y: 28, w: 16, h: 30 } }, // 小熊's head / upper body
      { flash: "lantern-bright", sfx: "flare", hotspot: { x: 84, y: 8, w: 16, h: 40 } }, // paper lantern
  ...
  },
  {
    ...
    extras: [
      ...
      { flash: "window-owlet", sfx: "hoo", hotspot: { x: 77, y: 48, w: 16, h: 24 } }, // lower round window
      { flash: "mailbox-bat", sfx: "flutter", hotspot: { x: 58, y: 66, w: 18, h: 24 } }, // the mailbox
    ],
  },
  {
    id: 10,
    ...
    interaction: {
      ...
      hotspot: { x: 47, y: 50, w: 15, h: 22 }, // the three stickers, mid-exchange
    },
    extras: [
      { flash: "moon-bright", sfx: "chime", hotspot: { x: 4, y: 4, w: 20, h: 24 } }, // moon, upper-left
      { flash: "owl-peek", sfx: "hoo", hotspot: { x: 58, y: 54, w: 15, h: 34 } }, // 猫头鹰 in the doorway
      { flash: "candle-flare", sfx: "flare", hotspot: { x: 64, y: 44, w: 10, h: 16 } }, // candle on the shelf
    ],
  },
  {
    id: 11,
  ...
  },
  {
    ...
    interaction: {
      ...
      sfx: "lullaby",
      to: "scene-off",
      hotspot: { x: 74, y: 36, w: 13, h: 26 }, // the bedside lamp
    },
    extras: [
      { flash: "moon-glow", sfx: "chime", hotspot: { x: 74, y: 0, w: 24, h: 32 } }, // window + moon, top-right
      { flash: "bag-glimmer", sfx: "chime", hotspot: { x: 88, y: 44, w: 11, h: 24 } }, // sticker bag on the nightstand
      { flash: "slippers-tuck", sfx: "tap", hotspot: { x: 52, y: 83, w: 18, h: 15 } }, // bunny slippers, bottom-centre
    ],
  },
];
